            ...
            <head>
                ...
                <style>
                    * {
                    ...
                    .stat-card:nth-child(2) .stat-icon { background: rgba(34, 197, 94, 0.2); }
                    .stat-card:nth-child(3) .stat-icon { background: rgba(236, 72, 153, 0.2); }
                ...
                <div class="container">
                    ...
                    <div class="footer">
                        <div class="tech-stack">
                            ...
                            <span class="tech-badge">H2 / PostgreSQL</span>
                        </div>
                        <div class="copyright">© 2024 ProdQ • Production Management Platform</div>
                    </div>
                </div>
