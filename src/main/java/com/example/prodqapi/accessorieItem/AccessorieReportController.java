...
@RestController
@RequestMapping("/accessorie_reports")
public class AccessorieReportController {
    private final String pdfDirectory = System.getProperty("user.dir") + "/accessorie_reports/";
