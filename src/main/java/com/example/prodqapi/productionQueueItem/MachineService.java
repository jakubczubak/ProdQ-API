...
public class MachineService {
    ...
    public Machine createMachine(MachineRequest request, MultipartFile imageFile) throws IOException {
        ...
        notificationService.sendNotification(NotificationDescription.MachineAdded, Map.of("name", savedMachine.getMachineName()));
        return savedMachine;
    }
    ...
    public Machine updateMachine(Integer id, MachineRequest request, MultipartFile imageFile) throws IOException {
        ...
        notificationService.sendNotification(NotificationDescription.MachineUpdated, Map.of("name", savedMachine.getMachineName()));
        return savedMachine;
    }
    ...
    public void deleteById(Integer id) {
        machineRepository.findById(id).ifPresent(machine -> {
            ...
            Path filePath = Paths.get(machine.getQueueFilePath(), machineName + ".txt");
            try {
            ...
            notificationService.sendNotification(NotificationDescription.MachineDeleted, Map.of("name", machineName));
