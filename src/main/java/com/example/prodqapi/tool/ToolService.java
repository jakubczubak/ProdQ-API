...
import com.example.prodqapi.toolGroup.ToolGroup;
import com.example.prodqapi.toolGroup.ToolGroupRepository;
...
public class ToolService {
    ...
    public void createTool(ToolDTO toolDTO) {
        ...
        notificationService.sendNotification(NotificationDescription.ToolAdded, Map.of("name", newTool.getName()));
    }
    ...
    public void deleteTool(Integer id) {
        ...
        notificationService.sendNotification(NotificationDescription.ToolDeleted, Map.of("name", toolName));
    }
    ...
    public void updateTool(ToolDTO toolDTO) {
        ...
        notificationService.sendNotification(NotificationDescription.ToolUpdated, Map.of("name", tool.getName()));
    }
    ...
    private void checkAndNotifyQuantityChange(Tool tool, ToolDTO toolDTO) {
        ...
        if (oldQuantity != newQuantity) {
            ...
            notificationService.sendQuantityNotification(NotificationDescription.ToolQuantityUpdated, Map.of(
                    "name", tool.getName(),
                    "oldValue", oldQuantityStr,
                    "newValue", newQuantityStr,
